...
def my_property_upload(cla):
    ...
    import os
    import numpy as np
    from action_zeno import mine_check, out_check, clean_screen
    ...
    try:
        ...
        file_path3 = dir_path + "\\zenonia\\mysettings\\game_server\\game_server.txt"
        ...
        while isstart1 is False:
            if os.path.isfile(file_path) == True:
                with open(file_path3, "r", encoding='utf-8-sig') as file:
                    ...
                    print('제노 game server', game_server)
                    # line3 => 게임서버
            else:
